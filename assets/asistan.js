...
(function () {
  ...
  var CEVAPLAR = [
    ...
    { k: /takip|durum|ilerleme|ne zaman|hangi aşama|hangi asama|takvim|plan(?!lama)/i,
      c: 'Proje ilerleyişi haftalık olarak raporlanır; güncel durumu ve sıradaki adımları WhatsApp üzerinden anında paylaşabiliriz.',
      l: [['📡 Takip Merkezi', 'takip']] },
    { k: /onay|karar|revizyon|kabul|imza/i,
      c: 'Onay ve kararlar WhatsApp üzerinden tek mesajla ilerliyor: strateji onayı, bütçe senaryosu seçimi ve yetki belgesi durumu. Hazır olduğunuzda yazmanız yeterli.',
      l: [['✅ Karar Defteri', 'kararlar']] },
    { k: /görsel|gorsel|logo|dosya|indir|arşiv|arsiv|varlık|varlik|feed|story/i,
      c: 'Kampanya görselleri ve 3 dilli setler ajans arşivinde hazır — istediğinizde WhatsApp üzerinden paylaşırız.',
    ...
    { k: /karne|skor|sağlık|saglik|qbr|değerlendir|degerlendir|çeyrek|ceyrek/i,
      c: 'Marka sağlık ölçümü çeyrek dönemlerde hazırlanır; güncel değerlendirmeyi toplantıda birlikte inceleriz.',
      l: [['📊 Karne', 'karne']] },
